...
| `msra_highlights` | object | ✅ (rides in the main sync doc as `highlights` — small) | `{conditionId: {fieldKey: [{s,e,t,c}]}}` — marker-pen highlights on Tracker condition field text. See the Highlighting section below |
